          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">support@fund-me.com</p>
                    <p className="text-gray-600">info@fund-me.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-4">
                <a href="/faq" className="block text-blue-600 hover:text-blue-800 transition-colors duration-200">
                  → Frequently Asked Questions
                </a>
                <a href="/support" className="block text-blue-600 hover:text-blue-800 transition-colors duration-200">
                  → Support Center
                </a>
